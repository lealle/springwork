...
insert into jpapaging values(jpapaging_seq.nextval, 'user27','user27@tjoeun.com');
insert into jpapaging values(jpapaging_seq.nextval, 'user28','user28@tjoeun.com');
insert into jpapaging values(jpapaging_seq.nextval, 'user29','user29@tjoeun.com');
insert into jpapaging values(jpapaging_seq.nextval, 'user30','user30@tjoeun.com');
